   ...
   <header>
    ...
    <section>
      ...
      <h5><i class="fas fa-feather-alt"></i>
        ...
        <a class="weatherwidget-io" href="https://forecast7.com/en/15d9179d74/andhra-pradesh/" data-label_1="ANDHRA PRADESH" data-label_2="WEATHER" data-theme="original" >ANDHRA PRADESH WEATHER</a>
        <script>
    ...
    <section id="places" class="section places-section">
      <class="places-container">
        <div class="place-card" data-aos="fade-up">
            <img src="./images/Andhra Pradesh/other/people.jpg" alt="People"  data-aos="flip-left">
        ...
        <div class="place-card" data-aos="fade-up">
            <img src="./images/Andhra Pradesh/other/RELIGIONS.gif" alt="Religions"  data-aos="flip-left">
            <div class="place-info">
                <h4>Religions</h4>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/other/Fairs and Festivals.jpg" alt="Fairs and Festivals"  data-aos="flip-left">
          <div class="place-info">
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/other/Architecture.jpg" alt="Architecture"  data-aos="flip-left">
          <div class="place-info">
              <h4>Architecture</h4>
              <p>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/other/Literature.jpg" alt="Literature"  data-aos="flip-left">
          <div class="place-info">
              <h4>Literature</h4>
              <p>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/other/Social Customs and Traditions.jpg" alt="Social Customs and Traditions"  data-aos="flip-left">
          <div class="place-info">
          ...
          <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                header("Location: AndP.php" . $_SERVER["PHP_SELF"]);
                exit();
            }
         ?>
