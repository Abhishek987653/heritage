    ...
    <div class="header-container">
        ...
        <nav>
            <ul>
                ...
                <li><a href="AndPFood.html">Food</a></li>
                <li><a href="AndPArt.html">Art and traditon</a></li>
                <li><a href="AndPnatural-park.html">Natural Parks</a></li>
                <li><a href="AndPbestplace.html">Places to Visit</a></li>
                <li> <a href="./AndP.html" target="_blank" style="border:0;"><button class="btn btn-blog" style="border: 0;">BACK</button></a></li>
            </ul>
        </nav>
    </div>
</header>
   ...
   <section id="places" class="section places-section">
    <div class="places-container">
        <div class="place-card" data-aos="fade-up">
            <img src="./images/Andhra Pradesh/places/Visakhapatnam.jpg" alt="Visakhapatnam" data-aos="flip-left">
            <div class="place-info">
                ...
                <p>Visakhapatnam, also commonly known as Vizag, is one of the oldest port cities in the country. Situated in the heart of Andhra Pradesh, Visakhapatnam is known for its picturesque beaches and serene landscape, as well as a rich cultural past. The port of Visakhapatnam is renowned for being home to the oldest shipyard in all of India. Located a short distance away from Visakhapatnam is Araku Valley, one of the prime attractions of Vizag. Situated at a lofty 910 metres above sea level, Araku Valley is a hill station replete with gushing waterfalls, crystal clear streams, lush green gardens and some challenging trekking trails.
                  ...
                  Vizag is dotted with many beaches along its coastline, with the most famous one being the Yarada Beach. One of the most stunning places to see in all of Visakhapatnam, Yarada beach is surrounded by majestic hills on three sides, and by the Bay of Bengal on the other side. One of the best things about Vizag’s beaches is that they are a lot cleaner and a lot less crowded than other famous beaches along the Indian coastline, and Yarada beach is no exception. It is the perfect place to sit back on the golden sands and witness a marvellous sunrise or sunset.</p>
            </div>
        </div>

        <div class="place-card" data-aos="fade-up">
            <img src="./images/Andhra Pradesh/places/tirupati.jpeg" alt="Tirupati"  data-aos="flip-left">
            <div class="place-info">
                <h4>Tirupati</h4>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/places/Amaravati.jpg" alt="Amaravathi"  data-aos="flip-left">
          <div class="place-info">
              <h4>Amaravathi</h4>
      ...
      It led to Amaravathi being chosen as the Capital of Andhra Pradesh. The word Amaravathi in itself was derived from the ancient capital of Satavahana dynasty. Pilgrims visit this town almost throughout the year owing to the number of temples and shrines that adorn the little town in different parts</p>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/places/Araku_Valley.jpg" alt="Araku Valley"  data-aos="flip-left">
          <div class="place-info">
              <h4>Araku Valley</h4>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/places/anathgiri.png" alt="Ananthagiri Hills"  data-aos="flip-left">
          <div class="place-info">
              <h4>Ananthagiri Hills</h4>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/places/vijaywada.jpg" alt="Vijayawada"  data-aos="flip-left">
          <div class="place-info">
              <h4>Vijayawada</h4>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/places/Gandikota-Fort.jpg" alt="Gandikota"  data-aos="flip-left">
          <div class="place-info">
              <h4>Gandikota</h4>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/places/Anantapur.jpg" alt="Anantapur"  data-aos="flip-left">
          <div class="place-info">
              <h4>Anantapur</h4>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/places/krunool.jpg" alt="Kurnool"  data-aos="flip-left">
          <div class="place-info">
              <h4>Kurnool</h4>
        ...
        <div class="place-card" data-aos="fade-up">
          <img src="./images/Andhra Pradesh/places/guntur.jpg" alt="Guntur"  data-aos="flip-left">
          <div class="place-info">
              <h4>Guntur</h4>
